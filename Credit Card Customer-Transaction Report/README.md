...
4. [Steps](#steps)
    ...
    2. [Data Modeling and Relationship Building](#data-modeling-and-relationship-building)
    3. [DAX Query Implementation](#dax-query-implementation)
    4. [Dashboard Design and Visualization](#dashboard-design-and-visualization)
    5. [Analysis and Insights](#analysis-and-insights)
5. [DAX Queries](#dax-queries)
    1. [Age Group Classification](#age-group-classification)
    2. [Income Group Classification](#income-group-classification)
    3. [Week Number for Transactions](#week-number-for-transactions)
    4. [Revenue Calculation](#revenue-calculation)
    5. [Current Week Revenue](#current-week-revenue)
    6. [Previous Week Revenue](#previous-week-revenue)
6. [Dashboards](#dashboards)
    1. [Overview Dashboard](#overview-dashboard)
    2. [Customer Segmentation Dashboard](#customer-segmentation-dashboard)
    3. [Spending Trends Dashboard](#spending-trends-dashboard)
    4. [High-Value Customer Analysis Dashboard](#high-value-customer-analysis-dashboard)
    5. [Geographic Performance Dashboard](#geographic-performance-dashboard)
7. [Key Insights & Results](#key-insights--results)
8. [Actionable Insights & Recommendations](#actionable-insights--recommendations)
...
![Credit Card Transaction Report](https://github.com/Abhishek-kanaujia/DATA-ANALYST-PORTFOLIO/blob/main/Credit%20Card%20Customer-Transaction%20Report/CreditCardTransactionReport.jpeg)
![Credit Card Customer Report](https://github.com/Abhishek-kanaujia/DATA-ANALYST-PORTFOLIO/blob/main/Credit%20Card%20Customer-Transaction%20Report/CreditCardCustomerReport.jpeg)
