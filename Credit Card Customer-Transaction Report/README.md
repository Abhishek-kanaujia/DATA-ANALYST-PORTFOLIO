...
Sure! Below is the updated README file with the DAX query explanations and the insights you provided incorporated:
...
This version of the README is designed to provide a comprehensive overview of your project and the DAX queries used in the analysis. You can now use this for your portfolio project in GitHub!
